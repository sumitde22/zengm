...
let timeSpendingTrades: number | undefined;
...
const betweenAiTeams = async () => {
	...
	timeSpendingTrades = !timeSpendingTrades
		? secondsElapsed
		: timeSpendingTrades + secondsElapsed;
	console.log(
		`Total time spent finding AI-to-AI trades: ${timeSpendingTrades}`,
	);
};
